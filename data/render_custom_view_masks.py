...
def main():
    ...
    parser.add_argument(
        "--precomputed_mask",
        type=str,
        default="/raid/home/than/zhiyuan/jetauto_rl_navigation/data/blue_bin_mask_from_2d.pt",
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/raid/home/than/zhiyuan/jetauto_rl_navigation/data/mask_renders",
    )
    parser.set_defaults(
